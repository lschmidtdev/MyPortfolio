...
class AppColors {
  ...
  static const Color speechToText = Color(0xFFB41100);

  static const Color coomingSoon = Color(0xFF6B79F6);
  static const Color coomingSoonNavTitle =  Color(0xFFB2B9CF);
  static const Color coomingSoonSelectedNavTitle =  Color(0xFF212455);
  static const Color coomingSoonAppLogo =  Color(0xFF808BF6);
